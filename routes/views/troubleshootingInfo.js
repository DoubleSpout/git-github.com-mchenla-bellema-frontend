...
exports = module.exports = function (req, res) {
	...
	//count 
	asyncList.push(function(callback){
		keystone.list('TroubleShooting').model.count({'state':'published'}).exec(function (err, results) {
	...
	asyncList.push(function(callback){
		...
		keystone.list('TroubleShooting').model.find({'_id':id}).limit(1).exec(function (err, results) {
