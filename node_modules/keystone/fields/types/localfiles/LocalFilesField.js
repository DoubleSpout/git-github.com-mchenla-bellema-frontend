...
var Item = React.createClass({
	...
	render: function () {
		...
		body.push(<a href={'/upload/'+filename} target="_blank"><img className='file-icon' src={'/keystone/images/icons/32/' + iconName + '.png'} /></a>);
		body.push(<span className='file-filename'><a href={'/upload/'+filename} target="_blank">{filename}</a></span>);
