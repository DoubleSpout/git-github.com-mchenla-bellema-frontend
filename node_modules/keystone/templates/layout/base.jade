					...
					ul(class="nav navbar-nav")
						...
						li(class="dropdown")
							...
							ul(class="dropdown-menu",role="menu")
								li
									a(href="/keystone/banners")|Banner
								li(class="divider")
								li
									a(href="/keystone/home-customs")|HomeCustom
								li(class="divider")
								li
									a(href="/keystone/partners")|Partners
								li(class="divider")
								li
									a(href="/keystone/advs")|Advs
						...
						li(class="dropdown")
							...
							ul(class="dropdown-menu",role="menu")
								li
									a(href="/keystone/products")|Products
								li(class="divider")
								li
									a(href="/keystone/product-categories")|Product Category
								li(class="divider")
								li
									a(href="/keystone/reviews")|Review
						...
						li(class="dropdown")
							...
							ul(class="dropdown-menu",role="menu")
								li
									a(href="/keystone/distributors")|Distributor
								li
									a(href="/keystone/shops")|Shops
						...
						li(class="dropdown")
							...
							ul(class="dropdown-menu",role="menu")
								li
									a(href="/keystone/supports")|Supports
						...
						li(class="dropdown")
							...
							ul(class="dropdown-menu",role="menu")
								li
									a(href="/keystone/socials")|Socials
								...
								nav(class="widget-body")
									ul(class="acc-menu")
										...
										li(class="hasChild")
											...
											ul(class="acc-menu")
												li
													a(href="/keystone/blogs")|Blogs
												li
													a(href="/keystone/blog-categories")|BlogCategories
...
script(src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAxoHn2ExXBMjvV522DUrL-5jeFZ3im_PU&callback=initMap",async,defer)